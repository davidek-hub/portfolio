...
// Kamera je posunutá na hodnotu 150, aby obsáhla celý beacon
...
loader.load(
  './NetheriteBlockBeacon.glb', // Kostka umístěná vedle index.html
  function (gltf) {
    ...
    console.log("Beacon byl načten a umístěn!");
  },
  function (xhr) {
